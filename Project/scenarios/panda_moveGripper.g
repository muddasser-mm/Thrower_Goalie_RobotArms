...
Edit finger1{ joint:transX Q:<> A:<t(+.07 0 -.05)> limits: [-.05 0.02], contact: -2, shape:capsule, size:[.02, .02], color:[0.4 0.4 0.4] }
Edit finger2{ joint:transX mimic:(finger1) Q:<> A:<d(180 0 0 1) t(+.07 0 -.05)>, contact: -2, shape:capsule, size:[.02, .02], color:[0.2 0.2 0.2]}
